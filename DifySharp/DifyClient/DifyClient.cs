...
public class KnowledgeBaseClient : DifyClientProxy<IKnowledgeBaseApi>, IKnowledgeBaseApi
{
    ...
    public async Task<CreateByFile.ResponseBody> PostCreateDocumentByFileAsync(string datasetId,
        CreateByFile.RequestBody                                                      body, FileInfo file)
    {
    ...
    public async Task<KnowledgeBase.Chunk.Get.ResponseBody> GetSegments(string datasetId, string documentId,
        string                                                                 keyword,   string status)
    {
        return await Api.GetSegments(datasetId, documentId, keyword, status);
    }
